...
export const GOAL_DEFINITIONS: Record<string, GoalDefinition> = {
	...
	water: {
		...
		emoji: "💧",
		description:
			"Submit proof of 1 gallon water intake from any water tracking log.",
		requiresImage: true,
		requiresText: false,
	},
	sleep: {
	...
	food: {
		...
		emoji: "🍔",
		description:
			"Submit what you ate for today, as an image from MyFitnessPal or as text.",
		requiresImage: false,
		requiresText: true,
	},
	"job applications": {
		...
		emoji: "📄",
		description:
			"Submit a screenshot of your entries for today from your spreadsheet.",
		requiresImage: true,
		requiresText: false,
	},
	exercise: {
	...
	reading: {
		...
		emoji: "📕",
		description:
			"Submit what book you read, and what chapter you completed. Optionally, you can summarize.",
		requiresImage: false,
		requiresText: true,
	},
	"late-eats": {
		...
		emoji: "🍽️",
		description:
			"Did you eat anything after 10PM yesterday? Submit a photo of what you ate or text describing it.",
		requiresImage: false,
		requiresText: true,
	},
};
...
export const WEEKLY_GOAL_DEFINITIONS: Record<string, GoalDefinition> = {
	cafe: {
		...
		emoji: "☕",
		description:
			"Submit a picture of your coffee/cafe that you went to for the week.",
		requiresImage: true,
		requiresText: false,
	},
	portfolio: {
		...
		emoji: "",
		description:
			"Submit proof of portfolio work done this week. This could be a screenshot of code, a design mockup, or description of what you built.",
		requiresImage: false,
		requiresText: true,
	},
	ternship: {
		...
		emoji: "🏢",
		description:
			"Submit proof of work done on your internship project this week. This could be a screenshot of code, a document, or description of what you accomplished.",
		requiresImage: false,
		requiresText: true,
	},
};
...
export function getGoalDefinition(roleName: string): GoalDefinition | null {
	...
	const goalDef = GOAL_DEFINITIONS[roleName.toLowerCase()];
...
export function getWeeklyGoalDefinition(
	roleName: string,
): GoalDefinition | null {
	// First try direct lookup
	const goalDef = WEEKLY_GOAL_DEFINITIONS[roleName.toLowerCase()];
	if (goalDef) return goalDef;
