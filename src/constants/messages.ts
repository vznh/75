...
export const MESSAGES = {
  ENTRY: {
    CREATION_STARTED: '(・∀・) Entry creation started! Check the archive channel for your thread.',
    CREATION_ERROR: '(ಠ_ಠ) Error starting entry. Please try again.',
    ALREADY_EXISTS: 'Thread already exists for user - Day',
    ALL_GOALS_COMPLETE: '✅ All goals completed! Entry will be finalized shortly.',
  ...
  SUBMISSION: {
    INVALID_GOAL: '(ಠ_ಠ) Could not determine which goal this submission is for. Please reply to a specific goal embed.',
    ALREADY_SUBMITTED: '(・_・) You already submitted this goal. First submission counts!',
