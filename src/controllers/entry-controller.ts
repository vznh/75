...
export class EntryController {
  static async handleCreateEntryButton(interaction: ButtonInteraction): Promise<void> {
  ...
  static async handleViewEntriesButton(interaction: ButtonInteraction): Promise<void> {
    await interaction.deferReply({ ephemeral: true });
  ...
  static async handleShareThreadButton(interaction: ButtonInteraction): Promise<void> {
    await interaction.deferReply({ ephemeral: true });
